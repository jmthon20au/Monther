...
banned_words = ['كسمك','كسعمتك','كسختك','عيري','اير','عير','زب','زوب','كسي','طيز','خالتك','كسك','مصلي','موطه','موطة','موطلي','كسختك','عير باختك','عير بامك','عير بيك','بلاع','نيج','نيجني','انيجك','امك الكحبه','اختك الكحبه','تيل بيك','تيل','سكسي','سكس','sex','+18','نيجه','مصه','كحبه','كحبه','امك تنيج','اختك تنيج','خالتك الشكرا','خالتك الشكره','خالتك الشكرة','وردي','ما اتحمل','كله لو بس الراس','مصيلي','🍑'"كسك","ابن الكحبه","انيجك","كواد","بربوك","زربان","سكس","كسكوس","اختك","عير","عيري","ايري","امك انيجها","نيجها","طيزي","طيزك","طيزج","ولج بربوك"," انيجج","متبربكه","كواده","ابو العيوره","ام العيوره"] 
...
print("تم تشغيل البوت اصدار  1.0")
bot.polling()
